//Generated by MigrationGenerator, 30.09.2020 13:25:26
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202009301325)]
	public class Migration202009301325 : Migration
	{
		public override void Up()
		{
			...
			//Database.AddForeignKey("bridge_to_i_list<_bridge_support>_5", "bridges_bridge", "supports_id", "i_list<_bridge_support>", "id");
			//Database.AddForeignKey("bridge_to_i_list<_span_structure>_6", "bridges_bridge", "span_structures_id", "i_list<_span_structure>", "id");
			Database.AddForeignKey("bridge_to_feature_object_7", "bridges_bridge", "feature_object_id", "featureobject", "id");
		...
		public override void Down()
		{
			...
			//Database.RemoveForeignKey("bridges_bridge", "bridge_to_i_list<_bridge_support>_5");
			//Database.RemoveForeignKey("bridges_bridge", "bridge_to_i_list<_span_structure>_6");
			Database.RemoveForeignKey("bridges_bridge", "bridge_to_feature_object_7");
