//Generated by MigrationGenerator, 18.09.2020 16:26:38
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202009181626)]
	public class Migration202009181626 : Migration
	{
		public override void Up()
		{
			...
			//Database.AddForeignKey("bridge_to_list<_bridge_obstacle>_0", "bridges_bridge", "obstacles_id", "list<_bridge_obstacle>", "id");
			...
			//Database.AddForeignKey("bridge_to_i_list<_bridge_support>_6", "bridges_bridge", "supports_id", "i_list<_bridge_support>", "id");
			//Database.AddForeignKey("bridge_to_i_list<_span_structure>_7", "bridges_bridge", "span_structures_id", "i_list<_span_structure>", "id");
			Database.AddForeignKey("bridge_to_feature_object_8", "bridges_bridge", "feature_object_id", "featureobject", "id");
		...
		public override void Down()
		{
			...
			//Database.RemoveForeignKey("bridges_bridge", "bridge_to_i_list<_bridge_support>_6");
			//Database.RemoveForeignKey("bridges_bridge", "bridge_to_i_list<_span_structure>_7");
			Database.RemoveForeignKey("bridges_bridge", "bridge_to_feature_object_8");
