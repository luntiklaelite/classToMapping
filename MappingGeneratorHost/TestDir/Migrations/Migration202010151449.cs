//Generated by MigrationGenerator, 15.10.2020 14:49:17
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202010151449)]
	public class Migration202010151449 : Migration
	{
		public override void Up()
		{
			...
			Database.ExecuteNonQuery("INSERT INTO bridges_material(id, name) VALUES(1, 'Железобетон'), (2, 'Бетон'), (3, 'Сталь'), (4, 'Сталежелезобетон'), (5, 'Бутобетон'), (6, 'Каменная или бетонная кладка'), (7, 'Железобетон преднапряженный'), (8, 'Алюминий'), (9, 'Композитный материал'), (10, 'Древесина'), (11, 'Древесина клееная'), (12, 'Прочее'), (13, 'Нет данных')");
