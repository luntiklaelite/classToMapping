//Generated by MigrationGenerator, 31.08.2020 12:54:50
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202008311254)]
	public class Migration202008311254 : Migration
	{
			...
			Database.AddTable("bridges_bridge", new[]
				{
					...
					new Column("first_obstacle_type", DbType.String, "Type1"),
					new Column("first_obstacle_type_id", DbType.Int64),
					new Column("second_obstacle_type", DbType.String, "Type1"),
					new Column("second_obstacle_type_id", DbType.Int64),
					new Column("road_category", DbType.String, "IA"),
					...
					new Column("location_in_plan", DbType.String, "Direct"),
					new Column("location_in_plan_id", DbType.Int64),
					new Column("cover_type", DbType.String, "AsphaltConcrete"),
					new Column("cover_type_id", DbType.Int64),
					new Column("drainage_type", DbType.String, "None"),
					new Column("drainage_type_id", DbType.Int64),
					new Column("expansion_joints_type", DbType.String, "Opened"),
					...
					new Column("sidewalks", DbType.String, "None"),
					new Column("sidewalks_id", DbType.Int64),
					new Column("railings", DbType.String, "None"),
					...
					new Column("regulatory_structures", DbType.String, "JetGuideSlopeReinforcement"),
					new Column("regulatory_structures_id", DbType.Int64),
					new Column("cones_strengthening", DbType.String, "Odernovka"),
					...
					new Column("communications", DbType.String, "NoData"),
					new Column("communications_id", DbType.Int64),
					new Column("arrangements", DbType.String, "NoData"),
					...
					new Column("status", DbType.String, "Set"),
					new Column("status_id", DbType.Int64),
					new Column("feature_object_id", DbType.Int64),
					new Column("quality_bridge_type", DbType.String, "Good"),
					new Column("quality_bridge_type_id", DbType.Int64),
					new Column("construction_type", DbType.String, "Ferroconcrete"),
					new Column("construction_type_id", DbType.Int64),
					new Column("move_type", DbType.String, "Type1"),
			...
			Database.AddTable("bridges_bridge_support", new[]
				{
					...
					new Column("notes", DbType.String),
					new Column("support_type", DbType.String, "MassiveSolid"),
					new Column("support_type_id", DbType.Int64),
					new Column("foundation_type", DbType.String, "ShallowShoe"),
			...
			Database.AddTable("bridges_protection", new[]
				{
					...
					new Column("type", DbType.String, "Parapet"),
			...
			Database.AddTable("bridges_span_structure", new[]
				{
					...
					new Column("notes", DbType.String),
					new Column("system", DbType.String, "Beam"),
					new Column("system_id", DbType.Int64),
					new Column("span_structure_type", DbType.String, "RibbedBeamWithDiaphragms"),
					new Column("span_structure_type_id", DbType.Int64),
					new Column("construction_roadway", DbType.String, "FerroconcreteSlabInMainSupStruct"),
					new Column("construction_roadway_id", DbType.Int64),
					new Column("material_id", DbType.Int64),
					new Column("construction_year_id", DbType.Int64),
					new Column("typical_project_id", DbType.Int64),
					new Column("span_type_movable", DbType.String, "None"),
					new Column("span_type_movable_id", DbType.Int64),
					new Column("span_type_motionless", DbType.String, "None"),
					new Column("span_type_motionless_id", DbType.Int64),
					new Column("joint_type", DbType.String, "Opened"),
					new Column("joint_type_id", DbType.Int64),
					new Column("cross_join", DbType.String, "None"),
