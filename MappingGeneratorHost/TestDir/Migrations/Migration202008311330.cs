//Generated by MigrationGenerator, 31.08.2020 13:30:17
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202008311330)]
	public class Migration202008311330 : Migration
	{
		public override void Up()
		{
			...
			//Database.AddForeignKey("bridge_to_date_time_0", "bridges_bridge", "construction_year_id", "date_time", "id");
			//Database.AddForeignKey("bridge_to_date_time_1", "bridges_bridge", "reconstruction_year_id", "date_time", "id");
			//Database.AddForeignKey("bridge_to_date_time_2", "bridges_bridge", "repairs_year_id", "date_time", "id");
			Database.AddForeignKey("bridge_to_protection_3", "bridges_bridge", "protection_on_bridge_id", "bridges_protection", "id");
			Database.AddForeignKey("bridge_to_protection_4", "bridges_bridge", "protection_on_approach_id", "bridges_protection", "id");
			Database.AddForeignKey("bridge_to_bridge_side_5", "bridges_bridge", "start_bridge_side_id", "bridges_bridge_side", "id");
			Database.AddForeignKey("bridge_to_bridge_side_6", "bridges_bridge", "end_bridge_side_id", "bridges_bridge_side", "id");
			//Database.AddForeignKey("bridge_to_adapter_plates_availability_7", "bridges_bridge", "adapter_plates_id", "adapter_plates_availability", "id");
			Database.AddForeignKey("bridge_to_organization_8", "bridges_bridge", "project_organization_id", "organization", "id");
			Database.AddForeignKey("bridge_to_organization_9", "bridges_bridge", "building_company_id", "organization", "id");
			Database.AddForeignKey("bridge_to_organization_10", "bridges_bridge", "exploit_organization_id", "organization", "id");
			//Database.AddForeignKey("bridge_to_date_time_11", "bridges_bridge", "date_view_id", "date_time", "id");
			//Database.AddForeignKey("bridge_to_i_list<_bridge_support>_12", "bridges_bridge", "supports_id", "i_list<_bridge_support>", "id");
			//Database.AddForeignKey("bridge_to_i_list<_span_structure>_13", "bridges_bridge", "span_structures_id", "i_list<_span_structure>", "id");
			Database.AddForeignKey("bridge_to_feature_object_14", "bridges_bridge", "feature_object_id", "featureobject", "id");
			...
			//Database.AddForeignKey("span_structure_to_date_time_1", "bridges_span_structure", "construction_year_id", "date_time", "id");
			Database.AddForeignKey("span_structure_to_typical_project_2", "bridges_span_structure", "typical_project_id", "bridges_typical_project", "id");
			Database.AddForeignKey("span_structure_to_material_3", "bridges_span_structure", "plate_material_id", "bridges_material", "id");
			Database.AddForeignKey("span_structure_to_span_pile_4", "bridges_span_structure", "cross_pile_id", "bridges_span_pile", "id");
			Database.AddForeignKey("span_structure_to_span_pile_5", "bridges_span_structure", "longitudinal_pile_id", "bridges_span_pile", "id");
