//Generated by MigrationGenerator, 12.10.2020 15:00:30
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202010121500)]
	public class Migration202010121500 : Migration
	{
		public override void Up()
		{
			Database.AddTable("bridges_bridge", new[]
				{
					...
					new Column("defects_id", DbType.Int64),
				});
			...
			Database.AddForeignKey("bridge_to_organization_2", "bridges_bridge", "project_organization_id", "info_organization", "id");
			Database.AddForeignKey("bridge_to_organization_3", "bridges_bridge", "building_organization_id", "info_organization", "id");
			Database.AddForeignKey("bridge_to_organization_4", "bridges_bridge", "exploit_organization_id", "info_organization", "id");
			Database.AddForeignKey("bridge_to_feature_object_5", "bridges_bridge", "feature_object_id", "featureobject", "id");
			...
			Database.AddForeignKey("defect_to_bridge_0", "bridges_defect", "bridge_id", "bridges_bridge", "id");
			...
			Database.ExecuteNonQuery("INSERT INTO bridges_material(id, name) VALUES (1, 'Железобетон'), (2, 'Бетон'), (3, 'Бутобетон'), (4, 'Каменная или бетонная кладка'), (5, 'Древесина'), (6, 'Железобетон преднапряженный'), (7, 'Сталь'), (8, 'Сталежелезобетон'), (9, 'Древесина клееная'), (10, 'Алюминий'), (11, 'Композитный материал'), (12, 'Прочее'), (13, 'Нет данных')"); 
		}
		...
		public override void Down()
		{
			...
			Database.RemoveForeignKey("bridges_bridge", "bridge_to_organization_2");
			...
			Database.RemoveForeignKey("bridges_bridge", "bridge_to_feature_object_5");
			...
			Database.RemoveForeignKey("bridges_defect", "defect_to_bridge_0");
