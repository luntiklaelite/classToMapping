//Generated by MigrationGenerator, 31.08.2020 13:49:59
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202008311349)]
	public class Migration202008311349 : Migration
	{
		public override void Up()
		{
			...
			//Database.AddForeignKey("bridge_to_adapter_plates_availability_4", "bridges_bridge", "adapter_plates_id", "adapter_plates_availability", "id");
			Database.AddForeignKey("bridge_to_organization_5", "bridges_bridge", "project_organization_id", "organization", "id");
			Database.AddForeignKey("bridge_to_organization_6", "bridges_bridge", "building_company_id", "organization", "id");
			Database.AddForeignKey("bridge_to_organization_7", "bridges_bridge", "exploit_organization_id", "organization", "id");
			//Database.AddForeignKey("bridge_to_i_list<_bridge_support>_8", "bridges_bridge", "supports_id", "i_list<_bridge_support>", "id");
			//Database.AddForeignKey("bridge_to_i_list<_span_structure>_9", "bridges_bridge", "span_structures_id", "i_list<_span_structure>", "id");
		...
		public override void Down()
		{
			...
			Database.RemoveTable("bridges_BridgeSide");
			Database.RemoveTable("bridges_BridgeSupport");
			Database.RemoveTable("bridges_Material");
			Database.RemoveTable("bridges_Protection");
			Database.RemoveTable("bridges_SpanPile");
			Database.RemoveTable("bridges_SpanStructure");
			Database.RemoveTable("bridges_TypicalProject");
			Database.RemoveTable("bridges_ArrangementsStrings");
			Database.RemoveTable("bridges_BridgeMotionlessSupportStrings");
			Database.RemoveTable("bridges_BridgeMovableSupportStrings");
			Database.RemoveTable("bridges_BridgeStatusStrings");
			Database.RemoveTable("bridges_BridgeSupportMaterialStrings");
			Database.RemoveTable("bridges_BridgeSupportTypeStrings");
			Database.RemoveTable("bridges_BridgeTypeStrings");
			Database.RemoveTable("bridges_CommunicationsStrings");
			Database.RemoveTable("bridges_ConstructionRoadwayStrings");
			Database.RemoveTable("bridges_ConstructionTypeStrings");
			Database.RemoveTable("bridges_CoverTypeStrings");
			Database.RemoveTable("bridges_CrossJoinMethodStrings");
			Database.RemoveTable("bridges_DrainageTypeStrings");
			Database.RemoveTable("bridges_ExpansionJointTypeStrings");
			Database.RemoveTable("bridges_FoundationTypeStrings");
			Database.RemoveTable("bridges_LocationInPlanStrings");
			Database.RemoveTable("bridges_MainSupportingStructureTypeStrings");
			Database.RemoveTable("bridges_MoveTypeStrings");
			Database.RemoveTable("bridges_ObstaclesTypeStrings");
			Database.RemoveTable("bridges_ProtectionTypeStrings");
			Database.RemoveTable("bridges_QualityStrings");
			Database.RemoveTable("bridges_RailingsTypeStrings");
			Database.RemoveTable("bridges_RegulatoryStructuresStrings");
			Database.RemoveTable("bridges_RoadCategoryStrings");
			Database.RemoveTable("bridges_SidewalkTypeStrings");
			Database.RemoveTable("bridges_SpanStructureMaterialStrings");
			Database.RemoveTable("bridges_SpanStructureSystemStrings");
			Database.RemoveTable("bridges_StrenghteningStrings");
		}
	}
}
