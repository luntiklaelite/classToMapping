//Generated by MigrationGenerator, 14.09.2020 12:26:59
using System.Data;
...
namespace ITS.DbMigration.Bridges
{
	...
	/// </summary>
	[Migration(202009141226)]
	public class Migration202009141226 : Migration
	{
		public override void Up()
		{
			Database.AddTable("bridges_bridge", new[]
				{
					...
					new Column("railings", DbType.Byte, (object)0),
					...
					new Column("adapter_plates", DbType.Byte, (object)0),
					...
					new Column("info_of_repairs", DbType.Int16, (object)0),
			...
			Database.AddTable("bridges_bridge_support", new[]
				{
					...
					new Column("notes", DbType.String),
					new Column("support_movable_type", DbType.Byte, (object)0),
					new Column("support_motionless_type", DbType.Byte, (object)0),
			...
			//Database.AddForeignKey("bridges_bridge", "bridge_to_bridge_side_3", "bridges_bridge", "end_bridge_side_id", "bridge_side", "id");
			Database.AddForeignKey("bridge_to_organization_4", "bridges_bridge", "project_organization_id", "info_organization", "id");
			Database.AddForeignKey("bridge_to_organization_5", "bridges_bridge", "building_organization_id", "info_organization", "id");
			Database.AddForeignKey("bridge_to_organization_6", "bridges_bridge", "exploit_organization_id", "info_organization", "id");
			//Database.AddForeignKey("bridges_bridge", "bridge_to_i_list<_bridge_support>_7", "bridges_bridge", "supports_id", "i_list<_bridge_support>", "id");
			//Database.AddForeignKey("bridges_bridge", "bridge_to_i_list<_span_structure>_8", "bridges_bridge", "span_structures_id", "i_list<_span_structure>", "id");
			Database.AddForeignKey("bridge_to_feature_object_9", "bridges_bridge", "feature_object_id", "featureobject", "id");
		...
		public override void Down()
		{
			...
			//Database.RemoveForeignKey("bridges_bridge", "bridge_to_i_list<_bridge_support>_7");
			//Database.RemoveForeignKey("bridges_bridge", "bridge_to_i_list<_span_structure>_8");
			Database.RemoveForeignKey("bridges_bridge", "bridge_to_feature_object_9");
